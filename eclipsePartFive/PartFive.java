...
{
	public static void one(Connection conn, Scanner input) throws SQLException {
		Statement s = conn.createStatement(); 
	 	System.out.println("This query will show all of the organizations and their leaders if they have any.");

	 	//Get all of the organizations and their leaders
	...
	public static void two(Connection conn, Scanner input) throws SQLException {
		
		//Get all of the students and their advisor's name!
		Statement s = conn.createStatement();
	...
	public static void three(Connection conn, Scanner input) throws SQLException {
		Statement s = conn.createStatement ();
		...
		String organizationID = input.nextLine();
		...
		String studentUIN = input.nextLine();
		...
		System.out.print("\nBelow is the organization you initally selected and the current members.\n");
	...
	public static void four(Connection conn, Scanner input) throws SQLException {
		String percentage = "0";
		String facultyid = "-1";
	...
	public static void five(Connection conn, Scanner input) throws SQLException {
		int UIN;
		String student;
		String major;
	...
	public static void main (String[] args)
	{
	   ...
	   while(keepGoing) {
		   ...
		   System.out.println("3. Remove a student from an organization.");
		   ...
		   try {
			   switch(in) {
				   case "1": one(conn, inputer);	break;
				   case "2": two(conn, inputer); 	break;
				   case "3": three(conn, inputer); 	break;
				   case "4": four(conn, inputer); 	break;
				   case "5": five(conn, inputer); 	break;
